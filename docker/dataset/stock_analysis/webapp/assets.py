...
def compile_static_assets(assets):
    ...
    indicators_less_bundle = Bundle(
        "indicators_bp/less/indicators.less",
        filters="less,cssmin",
        output="dist/css/indicators.css",
        extra={"rel": "stylesheet/less"},
    )
    ...
    dashboard_less_bundle = Bundle(
        "dashboard_bp/less/products.less",
        filters="less,cssmin",
        output="dist/css/products.css",
        extra={"rel": "stylesheet/less"},
    )
    ...
    assets.register("indicators_less_bundle", indicators_less_bundle)
